package com.example.dfreeman.etaandroidmockexample;
...
public class ContollerUnitTest {
    ...
    public void testParseRoutes() throws Exception {
        ...
        temp.add("125");
        temp.add("140");
        assertEquals(controller.parseRoutes(routesTest), temp);
    }

    @Test
    public void getDirection() throws Exception {
        assertEquals(controller.getDirection(routesTest, 1), "Northbound");
    }

    @Test
    public void getRouteId() throws Exception {
        assertEquals(controller.getRouteId(routesTest, 1), "2");
    }

    @Test
    public void getDaysActive() throws Exception {
        assertEquals(controller.getDaysActive(routesTest, 1), "Weekday");
    }
    ...
    public void getStops() throws Exception {
        ...
        assertEquals(controller.getStops(stopsTest), temp);
    }

    @Test
    public void testGetStopsUrl() throws Exception {
        assertEquals(controller.getStopsUrl(1, "1", "northbound", "weekday"), "http://ec2-204-236-211-33.compute-1.amazonaws.com:8080/companies/1/routes/1/northbound/weekday/1/stops");
    }

    @Test
    public void testGetRoutesUrl() throws Exception {
        assertEquals(controller.getRoutesUrl(1), "http://ec2-204-236-211-33.compute-1.amazonaws.com:8080/companies/1/routes");
    }
}
